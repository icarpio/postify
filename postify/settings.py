...
cloudinary.config(
    cloud_name=os.getenv('CLOUD_NAME'),  # Cambia si usas variables de entorno
    api_key=os.getenv('API_KEY'),  # Cambia si usas variables de entorno
    api_secret=os.getenv('API_SECRET'),  # Cambia si usas variables de entorno
    secure=True
)
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.getenv('EMAIL_USER')  # Tu correo electrónico os.getenv('EMAIL_USER')
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_PWD')  # Contraseña o App Password